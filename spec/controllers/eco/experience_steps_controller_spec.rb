...
describe Eco::ExperienceStepsController do
  ...
  before :each do
    ...
    # g = @current_user_eco.groups.first
  ...
  describe "GET index" do
    context "in order to create a new experience" do
      it "redirects to the wizzard" do
        get :index
        response.should redirect_to(eco_experience_step_path(:step1))
      end
    ...
    context "in order to update a existing experience" do
      it "redirects to the wizzard on experience state" do
        experience  = FactoryGirl.create(:experience, eco_id: @eco.id, state: 'step2')

        get :index, experience_id: experience.id
        response.should redirect_to(eco_experience_step_path(:step2))
      end
  ...
  describe "GET show" do
    ...
    context "in order to update a existing experience" do
      it "redirects to experiences path if experience cant be updated" do
      ...
      describe "renderea el template correcto" do
        ...
        it "when experience is on pending, incorrect step" do
          session[:experience_id] = @experience.id
          get :show, id: :pending
          response.should redirect_to(eco_experiences_path)
        end

        it "when experience is on pending, correct step" do
          session[:experience_id] = @experience.id
          get :show, id: :step1
          response.should render_template("step1")
        end
  ...
  describe "PUT update" do
    describe "with valid params" do
      context "in order to create a new experience" do
        ...
        it "debe guardar la experience" do
          ...
          expect {
            ...
            puts assigns(:experience).errors.full_messages
      ...
      context "in order to update a existing experience" do
        ...
        it "debe ir al siguiente paso" do
          session[:experience_id] = @experience.id
          put :update, id: :step2, experience: @valid_attributes_step2
          response.should redirect_to(eco_experience_step_path(:wicked_finish))
        end
    ...
    describe "with invalid params" do
      it "no debe considerar las exclusividades si es una eco chica" do
        session[:experience_id] = @experience.id
        @eco.bigger = false
        @eco.save
        @experience.total_exclusivity_sales = nil
        ...
        assigns(:experience).total_exclusivity_sales.should be_nil
        assigns(:experience).by_industry_exclusivity_sales.should be_nil
        assigns(:experience).without_exclusivity_sales.should be_nil
      end
      ...
      it "redirects to experiences path if experience cant be, requiring on step1" do
        session[:experience_id] = @experience2.id
        put :update, id: :step1, experience:  @valid_attributes_step1
        response.should redirect_to(eco_experiences_path)
      end

      it "redirects to experiences path if experience cant be, requiring on step2" do
        session[:experience_id] = @experience2.id
        put :update, id: :step2, experience:  @valid_attributes_step2
        response.should redirect_to(eco_experiences_path)
      end
